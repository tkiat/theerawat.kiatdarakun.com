  ...
  <>
    ...
    <p>
      ...
      <TooltipText text="more aware">
        While it can take forever to uncover the <i>actual</i> flows inside all sentient beings, I now know reasons behind many of my actions. For example, I should turn on a fan when my body needs it, and one sign for this is sweat. I shouldn't harm myself from any trauma, for the flow inside me matters, not illusory mind.
      </TooltipText>
