...
export const Story = (): React.ReactElement => (
  <>
    ...
    <hr />
    <p>
      <b className="big highlight">32 Years Old - Present (Finding a Full-Time Job)</b> — I am now&nbsp;
      <TooltipText text="more aware">
        While it can take forever to uncover the <i>actual</i> flows inside all sentient beings, I now know reasons behind many of my actions. For example, I should turn on a fan when my body needs it, and one sign for this is sweat. I shouldn't harm myself because of any trauma, because the flow inside me truly matters, while any illusory mind can matter but it isn't true.
      </TooltipText>
