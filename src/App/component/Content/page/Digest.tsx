...
export const Digest = (): React.ReactElement =>
  <div className="page-digest">
    <p>I list only some digital media that are DRM-free, part of a subscription with DRM, or free of charge here. I add summary a bit for the sake of memory retention.</p>
    ...
    <ul>
      ...
      <li>
        <span className="bold highlight">Organisms and the Earth: </span>
        <span>[2022] </span>
        <MyTooltipWithDelay text="Land of Hope and Glory">
          <a href="https://www.youtube.com/watch?v=dvtVkNofcq8"><b>[Documentary]</b></a> — A documentary about animal abuse in the UK about which the narrator proceeds from pigs, cows, birds, and finally sheeps. While I believe farms with less cruel conditions than those in the documentary exist, unnecessary killing is never justifiable. This documentary doesn't offer anything particularly new, but the pieces of footage reminds me what can possibly be wrong in the industry.
        </MyTooltipWithDelay>
      </li>

      <li>
        <span className="bold highlight">Digital: </span>

        <span>[2021] </span>
        <MyTooltipWithDelay text="Learn You a Haskell for Great Good!">
          <a href="http://learnyouahaskell.com/"><b>[Book]</b></a> — I mostly completed this book. I was pretty much lost in the later half at first. Having written a featureful pomodoro application in Haskell, I later reread it and finally understood it.
        </MyTooltipWithDelay>
        &ensp;
        <MyTooltipWithDelay text="Learning JavaScript Design Patterns">
          <a href="https://addyosmani.com/resources/essentialjsdesignpatterns/book"><b>[Book]</b></a> — I completed probably half of the book, and I will probably forget most of them. I have used the module pattern extensively in my personal website and perhaps in the future projects as well. I might reread it later.
        </MyTooltipWithDelay>
        &ensp;
        <MyTooltipWithDelay text="CIS194: Introduction to Haskell">
          <a href="https://www.seas.upenn.edu/~cis1940/spring13/lectures.html"><b>[Book]</b></a> — I read Learn You a Haskell book before but I couldn't quite get much of it. I then stumbled across the best free introduction Haskell course according to <a href="https://github.com/bitemyapp/learnhaskell">bitemyapp</a> so I took it. The instructor explains not very in details, which I found it sufficient. I gained much more understandings especially Monad. However, I didn't do any exercise since that seemed to take much time. You may request the solution from this <a href="https://github.com/byorgey/haskell-course">GitHub</a> link.
        </MyTooltipWithDelay>
        &nbsp;—&nbsp;
        <span>[2020] </span>
        <MyTooltipWithDelay text="Cloud Computing Basics">
          <a href="https://coursera.org/share/7fa417bc8244a27c8ccb08295906fb99"><b>[Course, Coursera]</b></a> — I took this short for fun as it offered a free certificate. It is a guide to cloud computing with a brief explanation of related technologies. This is a very short course (probably &lt; 3 hours with some preknowledge). The instructor at times reads what is shown on slides and not explains everything that appears on them so I personally don't recommend this course. You are better off reading Wikipedia in my opinion.
        </MyTooltipWithDelay>
        &nbsp;—&nbsp;
        <span>[2019] </span>
        <MyTooltipWithDelay text="React - The Complete Guide">
          <b><a href="https://www.udemy.com/course/react-the-complete-guide-incl-redux/">[Course, Udemy]</a></b> — A popular course about React.js for beginners. I paid and enrolled in this course as I wanted to build some websites (including my personal website). The basic contents are laid out nicely but the instructor didn't cover all advanced stuff. At the end he did a project that I followed along but I knew unless I did the project from scratch myself I wouldn't be familiar with the language.
        </MyTooltipWithDelay>
        &nbsp;—&nbsp;
        <span>[2019] </span>
        <MyTooltipWithDelay text="freeCodeCamp">
          <b>[Course]</b> — I became aware that the web knowledge offers me significant freedom so I took some 5 web-related courses here. The courses are about basics HTML/CSS/JS, fornt-end/back-end coding, React.js, and a few other libraries. I deleted my account there so the certificate links are gone.
        </MyTooltipWithDelay>
        &nbsp;—&nbsp;
        <span>[2018] </span>
        <MyTooltipWithDelay text="Algorithms">
          <a href="https://coursera.org/verify/specialization/LP2AXJ7TUNRV"><b>[Course, Coursera]</b></a> — I was unexplainably drawn to computer science just a month after coming back from Germany, and algorithms seemed like the most important basics so I took it. I paid 49 USD for the certificate and finished within a month. This coursera specialization contains 4 algorithm-related courses focusing deeply on theory. I would recommend this course for an aspiring computer scientist, but I was not that drawn much to the theoretical side so I skipped some lectures. I am not impressed with the assignment format since anyone can just put a correct number to pass the assignment.
        </MyTooltipWithDelay>
        &ensp;
        <MyTooltipWithDelay text="Data Structures and Algorithms">
          <a href="https://coursera.org/verify/specialization/MHRFWABPYTJU"><b>[Course, Coursera]</b></a> — I was addicted to the previous algorithm specialization so I took this speciailization also. It contains 6 courses, and the hidden corner cases for the assignments alone made this course already worth it. I paid 49 USD for the certificate and finished within a month. This specialization is, to me, very challenging, especially some tasks in the capstone project. Therefore, I think non full-time learners might take longer than a month.
          <br/><br/>
      ...
      <li>
        <span className="bold highlight">Others: </span>
        N/A
      </li>
    </ul>
    ...
    <ul>
      <li>
        <span className="bold highlight">Visual: </span>
      ...
      <li>
        <span className="bold highlight">Text: </span>
        N/A
      </li>
    </ul>
  </div>
