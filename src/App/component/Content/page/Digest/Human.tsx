...
export const Human = (): React.ReactElement =>
  <>
    ...
    <MyTooltipWithDelay text="พุทธธรรม ฉบับปรับขยาย">
      <a href="https://www.watnyanaves.net/th/book_detail/583">Link</a> — เหมือนหนังสือพุทธธรรม ฉบับเดิม แต่มีคำบรรยายเพิ่มเติมจากท่านผู้เขียนเข้ามามากขึ้น ไม่ได้สรุปเลยลืมไปแล้วคงต้องอ่านอีกรอบ
    </MyTooltipWithDelay>
    ,&nbsp;
    ...
    <MyTooltipWithDelay text="พระไตรปิฏก ฉบับประชาชน">
      <a href="http://library.nhrc.or.th/ulib/dublin.php?ID=2376">Link</a> — เป็นประไตรปิฏกฉบับย่อ รวมถึงประวัติพระไตรปิฏกอย่างคร่าวๆ ผมเห็นว่าคนไทยที่สนใจพุทธทุกคนควรอ่าน
    </MyTooltipWithDelay>
    ,&nbsp;
    <span>[2021] </span>
