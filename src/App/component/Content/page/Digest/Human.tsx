...
export const Human = (): React.ReactElement =>
  <>
    ...
    <MyTooltipWithDelay text="พุทธธรรม ฉบับเดิม">
      <a href="https://www.watnyanaves.net/th/book_detail/302"><b>[Book]</b></a> — หนังสือเล่มนี้เกี่ยวกับพุธธธรรมพื้นฐาน เป็นธรรมมะที่พระพุทธเจ้ามุ่งสอนคนทุกประเภท เกริ่นด้วยสภาพสังคมก่อนทรงตรัสรู้ คนพวกหนึ่งกำลังมัวเมาในวัตถุกับอีกพวกหนึ่งที่ปลีกตัวออกจากสังคมโดยสิ้นเชิงไปเป็นนักบวช จนถึงตอนตรัสรู้ แล้วแบ่งเนื้อหาเป็นสองตอน คือ
      <br/>
    ...
    <MyTooltipWithDelay text="พุทธธรรม ฉบับปรับขยาย">
      <a href="https://www.watnyanaves.net/th/book_detail/583"><b>[Book]</b></a> — เหมือนหนังสือพุทธธรรม ฉบับเดิม แต่มีคำบรรยายเพิ่มเติมจากท่านผู้เขียนเข้ามามากขึ้น ไม่ได้สรุปเลยลืมไปแล้วคงต้องอ่านอีกรอบ
    </MyTooltipWithDelay>
    &ensp;
    <MyTooltipWithDelay text="พุทธวจน คู่มือโสดาบัน">
      <a href="http://watnapp.com/book"><b>[Book]</b></a> — เป็นหนังสือที่คัดเฉพาะถ้อยคำพระพุทธเจ้าเกียวกับโสดาบัน โสดาบันเป็นเรื่องใหญ่ของคนนับถือพุทธ เหตุผลนึงเพราะเป็นจุดพ้นจากปุถุชนเป็นอริยะบุคคล และเชื่อกันว่าจะไม่ไปในเกิดในนรกแน่นอน ผมไม่เชื่อในนรกหรอกแต่โสดาบันก็ไม่ทำร้ายใครจึงน่ายกย่อง อยากสรุปแต่คงต้องอ่านอีกรอบ
    </MyTooltipWithDelay>
    &ensp;
    <MyTooltipWithDelay text="พุทธวจน อานาปานสติ">
      <a href="http://watnapp.com/book"><b>[Book]</b></a> — เป็นหนังสือที่คัดเฉพาะถ้อยคำพระพุทธเจ้าเกียวกับอานาปานสติ หลักๆคืออานาปานสติอย่างเดียวก็มีส่วนช่วยบรรลุธรรมได้มาก อยากสรุปแต่คงต้องอ่านอีกรอบ
    </MyTooltipWithDelay>
    &ensp;
