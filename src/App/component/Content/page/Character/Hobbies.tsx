...
export const Hobbies = (): React.ReactElement =>
  <section>
    ...
    <dl className="more-gap-list">
      ...
      <dd>Knowledge of philosophy should make my works (on things that can truly matter) more accessible and acceptable to the general public. I have yet to digest a lot of works but I will do so in my free time.</dd>
    </dl>
  </section>
