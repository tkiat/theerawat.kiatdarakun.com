  ...
  <>
    <ul>
      <li>
        ...
        <MyTooltip id="tt-wv-software" text="Ethical Software" place="bottom">
        ...
        &nbsp;|&nbsp;
        <MyTooltip id="tt-wv-drm" text="Ethical DRM" place="bottom">
        ...
        &nbsp;|&nbsp;
        <MyTooltip id="tt-wv-privacy" text="Online Privacy" place="bottom">
        ...
        &nbsp;|&nbsp;
        <MyTooltip id="tt-wv-proprietary" text="Proprietary Store" place="bottom">
      ...
      <li>
        ...
        <MyTooltip id="tt-wv-violence" text="Violence in Video Games">
        ...
        &nbsp;|&nbsp;
        <MyTooltip id="tt-wv-porn" text="Ethical Porn" place="bottom">
      ...
      <li>
        ...
        <MyTooltip id="tt-wv-abortion" text="Abortion">
      ...
      <li>
        ...
        <MyTooltip id="tt-wv-equality" text="Equality">
      ...
      <li>
        ...
        <MyTooltip id="tt-wv-food" text="Ethical Food">
        ...
        &nbsp;|&nbsp;
        <MyTooltip id="tt-wv-lifemeaning" text="Meaning of Life">
        ...
        &nbsp;|&nbsp;
        <MyTooltip id="tt-wv-travelling" text="Travelling">
        ...
        &nbsp;|&nbsp;
        <MyTooltip id="tt-wv-party" text="Party">
