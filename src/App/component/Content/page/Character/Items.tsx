  ...
  <>
    ...
    <ul>
      <li>
        ...
        <MyTooltip id="tt-it-laptop" text="Laptop">
          <ul>
        ...
        &nbsp;|&nbsp;
        <MyTooltip id="tt-it-mobile" text="Mobile">
          <ul>
            <li>HTC One M7</li>
        ...
        &nbsp;|&nbsp;
        <MyTooltip id="tt-it-audio" text="Audio">
          <ul>
        ...
        &nbsp;|&nbsp;
        <MyTooltip id="tt-it-storage" text="Storage">
          <ul>
        ...
        &nbsp;|&nbsp;
        <MyTooltip id="tt-it-peripheral" text="Peripheral">
          <ul>
      ...
      <li>
        ...
        &nbsp;|&nbsp;
        <MyTooltip id="tt-it-desktop" text="Desktop">
          <ul>
            <li>Editor: Neovim</li>
      ...
      <li>
        ...
        <MyTooltip id="tt-it-grooming" text="Grooming">
          <ul>
        ...
        &nbsp;|&nbsp;
        <MyTooltip id="tt-it-detergent" text="Detergent">
          <ul>
      ...
      <li>
        ...
        <MyTooltip id="tt-it-tea" text="Tea">
        ...
        &nbsp;|&nbsp;
        <MyTooltip id="tt-it-herbal" text="Heabal Tea">
      ...
      <li>
        ...
        <MyTooltip id="tt-it-shoe" text="Shoe">
          <ul>
            <li>One sandal</li>
            <li>One sneaker</li>
          </ul>
        ...
        &nbsp;|&nbsp;
        <MyTooltip id="tt-it-accessory" text="Accessory">
          <ul>
        ...
        &nbsp;|&nbsp;
        <MyTooltip id="tt-it-bicycle" text="Bicycle">
          <ul>
