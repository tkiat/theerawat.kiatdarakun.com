...
export const PurposeAndGoals = (): React.ReactElement =>
  <>
    ...
    <h1>Goals</h1>
    <MyTooltip id="tt-goal-pvp" text="My Personalities, Values, and Purpose">
    ...
    &nbsp;|&nbsp;
    <MyTooltip id="tt-goal-impact" text="Low Impact Life">
    ...
    &nbsp;|&nbsp;
    <MyTooltip id="tt-goal-software" text="Become a Software Craftsman">
