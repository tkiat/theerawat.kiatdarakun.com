...
export const About = (): React.ReactElement =>
  <>
    ...
    <p>One who seeks wisdom (i.e., the ability to make good judgments) needs to base his/her conscious actions on things that are true rather than illusory. In other words, a wise person would perform any conscious action based on true meaning, rather than false meaning or no meaning at all. My strong wish to become wise inspired me to philosophize on "true meaning" and also live by it myself. I split this work into two books of different scopes: individual and societal scopes.</p>
