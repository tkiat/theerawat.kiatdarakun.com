...
export const TrueMeaning = (): React.ReactElement =>
  <>
    ...
    <p>The passage of time forced me to either commit suicide or live and decide how to live, and my subjective self inspired me to live by true meaning. I wish to produce works about the true meaning on both individual and societal scales. These works are still in progress.</p>

    <h3 className="highlight">The True Meaning of Life</h3>

    <div>True meaning requires truths and meaning, which are in the eye of the beholder. Stumbling upon the vagueness of the terms, I started my abstract, contemplative journey to find a more specific explanation. This journey culminated in the realization that one may not know any absolute truth; however, one can instead live the least illusory path, which minimizes certainly illusory things, i.e., made-up things without any basis. This path requires these&nbsp;
      ...
      </TooltipText> of truths and meaning.
    </div>
    ...
    <p>Additionally, I will provide a record of my life that serves as one practical example of life with constant, authentic pursuits of true meaning. This record contains my choices (e.g., consumables, belongings, and routines) and the underlying reasons for them.</p>

    <h3 className="highlight">Society That Truly Serves Member</h3>

    <p>A fully functional society conforms to the true meaning of life (from the earlier work) that may vary among its members. In this work, I will examine the qualities of such society and how it abstractly satisfies its members. Next, I will describe concretely how that society tackles common issues such as media, food &amp; drinks, human rights, etc.</p>
  </>
