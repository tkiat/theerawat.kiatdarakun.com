...
export const WhatCanTrulyMatter = (): React.ReactElement =>
  <>
    ...
    <ul className="more-gap-list">
      <li>
        <p><b className="highlight">The meaning of life and what can truly matter</b>. There are many perspectives about the meaning of life, but all of them seem baseless. To escape from baselessness is to begin with what can truly matter and determine the meaning of life from there. This work investigates what can truly matter.</p>
      </li>
