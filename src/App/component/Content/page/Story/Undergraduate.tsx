...
export const Undergraduate = (): React.ReactElement =>
  <>
    ...
    <p>The English curriculum broadened my horizon (still limited in the technical area). My faculty simply has three choices: electronics, mechatronics, and communications. I prefer communications over the other two so I did an internship at&nbsp;
    <MyReactTooltip id="tt-s-thaicom" text="Thaicom">
      <p>It was a three-month internship in 2011 at Ladlumkaew, Thailand. I did nothing but observe the workers there do the tasks. There was a satellite installation training that I took for free. The final project is socket programming between a signal generator and a spectrum analyzer. I chose VB.net to carry out the task. Why? Because it seemed easy to use! During my free time, I write a Mario game with VB.net as a practice.</p>
    </MyReactTooltip>
    &nbsp;and doing my&nbsp;
    <MyReactTooltip id="tt-s-bachelorthesis" text="Thesis">
      <p>The thesis was organized into two parts: students are expected to plan and create an abstract in the first semester and execute it in the second semester. I chose the uplink and downlink-related topic and I didn't actually know how to carry it out so I was the only one who change the topic in the second semester. It was about the entropy of Thai text so I was proud to say that the Tripitaka was part of my thesis!</p>
    </MyReactTooltip>
