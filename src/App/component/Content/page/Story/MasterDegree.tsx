...
export const MasterDegree = (): React.ReactElement =>
  <>
    ...
    <div>I was still very ignorant about the direction in life but I felt that pursuing a Master's degree abroad was the best investment to do. I sent the applications to RWTH Aachen and TU Muenchen in Germany because of low to zero tuition fees,&nbsp;
      <MyTooltip id="tt-s-ranking" text="ranking">
      ...
      <MyTooltip id="tt-s-rwthfee" text="social contribution fee">
      ...
      <MyTooltip id="tt-s-rwthprep" text="preparation">
    ...
    <div>
      ...
      <MyTooltip id="tt-s-twostudents" text="two kind Thai students">
      ...
      <MyTooltip id="tt-s-lifestyle" text="lifestyle">
      ...
      , went to&nbsp;
      <MyTooltip id="tt-s-drilander" text="Dreilaenderpunkt">
      ...
      <MyTooltip id="tt-s-orientation" text="orientation">
      ...
      . The&nbsp;
      <MyTooltip id="tt-s-firstsem" text="first semester">
      ...
      <MyTooltip id="tt-s-anilroom" text="room">
      ...
      <MyTooltip id="tt-s-rwthgym" text="gym membership">
      ...
      &nbsp;and travel with my&nbsp;
      <MyTooltip id="tt-s-germanybicycle" text="bicycle">
      ...
      &nbsp;
      <MyTooltip id="tt-s-rwthnearbytrip" text="nearby">
      ...
      <MyTooltip id="tt-s-masterlength" text="two years">
    ...
    <div>
      ...
      <MyTooltip id="tt-s-mscthesis" text="stuff">
