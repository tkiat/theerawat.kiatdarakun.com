...
export const LongUnemployment = (): React.ReactElement =>
  <>
    ...
    <div>
      ...
      &nbsp;came to my mind. I first replaced Vista with Ubuntu and Void Linux. The Void Linux was performant and that was an eye-opener for me.
    </div>
    <br/>
    <div>
      I became interested in this liberating piece of software (Linux) and abandoned my PC. I sold my PC afterward and bought two used&nbsp;
