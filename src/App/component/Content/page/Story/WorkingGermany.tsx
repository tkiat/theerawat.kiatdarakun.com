...
export const WorkingGermany = (): React.ReactElement =>
  <>
    ...
    <div>Just before the end of my thesis I only applied to&nbsp;
      <MyTooltip id="tt-s-nidresden" text="National Instruments Dresden">
    ...
    &nbsp;and got the 6-month&nbsp;
      <MyTooltip id="tt-s-internoffer" text="offer">
        All internships in Germany were required to be paid by law. The stipend ranged from 550 EUR to 1700 EUR from what I had heard. The interns in the west and south generally paid more than the east but the living cost is also higher. Obviously, it was harder to get one if you don't have a working German proficiency but you should be able to find it nonetheless with some effort.
      </MyTooltip>
    . There were three other fellow&nbsp;
      <MyTooltip id="tt-s-fellowinterns" text="interns">
      ...
      <MyTooltip id="tt-s-internprague" text="Prague">
        <p>We booked a cheap hostel (10 EUR each) and in the night we visited a bar. There was some dancing lady with a lingerie who made her piece tighter after I stared at her. I felt sleepy but the guard prevented me from doing so and told me to sleep at my home instead. I never understand why would someone wanted to visit such a place.</p>
        <p>We went to a very old restaurant in Prague where we were served big poultry food and beer. We went to a castle to inspect the heritage of something old I actually didn't know anything about. The beer was nice though.</p>
      </MyTooltip>
      . The company has some&nbsp;
      <MyTooltip id="tt-s-perks" text="perks">
        Just free sugary drinks, coffee, and tea.
      </MyTooltip>
      &nbsp;but the best thing was&nbsp;
      <MyTooltip id="tt-s-buffets" text="buffets">
        One costs only 5 EUR and there was basically all you can eat including chickens, rice, and some soup. Another restaurant had similar meals but was limited to a given container.
      </MyTooltip>
      &nbsp;in the Vietnamese restaurants nearby. I carried out the internship&nbsp;
      <MyTooltip id="tt-s-tasks" text="tasks">
        Basically, some backlogs that engineers over there still didn't complete.
      </MyTooltip>
      &nbsp;day by day under the&nbsp;
      <MyTooltip id="tt-s-supervision" text="supervision">
      ...
      &nbsp;of a German engineer until it was finally the end of the internship when I was given a textbook but never read. I felt like I couldn't&nbsp;
      <MyTooltip id="tt-s-helpeng" text="help">
        I felt my personality didn't match with those engineers and the culture. I didn't want to change myself too much.
      </MyTooltip>
      &nbsp;those awesome German engineers much but I still wanted to stay there so I moved to nearby&nbsp;
      <MyTooltip id="tt-s-dresdenapartments" text="apartments">
        The first apartment is a one (or two I don't remember) stay with some random Russian people. My mother visited me shortly here and we went together to Prague. In the second apartment, I lived with German and French students where I knew that Crepe was way simpler than the one in Thailand.
      </MyTooltip>
      .
    </div>
    <br />
    <div>
      ...
      <MyTooltip id="tt-s-berlinapartment1" text="expensive one">
      ...
      . But I lost&nbsp;
      <MyTooltip id="tt-s-berlinlost" text="my luggage">
        A bag containing a lot like 600 EUR, tablet, laptop, and many other things. This complicated the issue since the house owner wanted the money right away. At that time, my mother was married to a guy in Norway and he very kindly gave (lend) me some money like 2000 EUR. I contacted the police about this incident but no one contacted me back.
      </MyTooltip>
      &nbsp;when I first reached Berlin train station. After this&nbsp;
      <MyTooltip id="tt-s-templeincident" text="incident">
        I visited the Buddhavihara temple in Berlin in the hope to find another accommodation or at least someone to share a room with. I found somebody but still didn't reach a conclusion. The next day I accidentally met the abbot of that temple and he remembered me. I went with him to have some launch and then he suggested a nun who had an available apartment.
      </MyTooltip>
      , I stayed at a very&nbsp;
      <MyTooltip id="tt-s-berlinapartmentcheap" text="cheap">
      ...
      <MyTooltip id="tt-s-berlingermancourses" text="courses">
      ...
      <MyTooltip id="tt-s-berlinjob" text="job">
        <p>A job that valued Thai ability at Arvato Bertelsmann. I so far hadn't applied to any engineering job in Germany partly because I felt they don't need me except for cleaning and restaurant jobs but got rejected. I thought I would be needed there because I could speak Thai.</p>
        <p>A job is more social-science related, not engineering at all which was fine as I didn't care much. I declined the full-time position and took part-time for 30 hours per week first. 9 months later, I converted to a full-time worker.</p>
      </MyTooltip>
      &nbsp;around 8km from my apartment. I invited my father&nbsp;
      <MyTooltip id="tt-s-berlinfather" text="here">
      ...
      <MyTooltip id="tt-s-arvatoexperience" text="experience">
      ...
      <MyTooltip id="tt-s-berlinmonotony" text="monotony">
      ...
      <MyTooltip id="tt-s-berlinnorwayvisit" text="visited">
        <p>She lived in Kristiansan, Norway. The weather at that time was snowy and the town was crowded. We went with her husband on a ferryboat to Denmark where he bought an art piece and we visited an underwater museum.</p>
      ...
      &nbsp;her back. I had to&nbsp;
      <MyTooltip id="tt-s-schipolsleep" text="sleep">
