      ...
      <ul className="ul-more-space">
        <li>
          ...
          <TooltipTextWithDelay text="MBTI">
            <span>Taken on 31 Mar 2021 from <a href="https://www.16personalities.com/">here</a></span>
            <br />
            <br />
            <ul>
          ...
          <TooltipTextWithDelay text="Big 5">
            <span>Taken on 31 Mar 2021 from <a href="https://openpsychometrics.org/tests/IPIP-BFFM/">here</a></span>
            <br />
            <br />
            <ul>
          ...
          <TooltipTextWithDelay text="Four Temperaments">
            <span>Taken on 31 Mar 2021 from <a href="http://openpsychometrics.org/tests/O4TS/">here</a></span>
            <br />
            <br />
            <ul>
              <li>Choleric: 12</li>
        ...
        <li>
          ...
          <TooltipText text="(Free and) Open Source Software">
            <p>Software (for both desktop and web) is crucial to my works as it enables me to create and share my thoughts to the whole world in any creative form that text alone cannot convey.</p>

            <p>I advocate FOSS operating systems (since they are very fundamental), the availability of FOSS application software alternatives (for accessibility to the poor), and OSS for entertainment softeware like video games (for the sake of transparency).</p>
          </TooltipText>
          ,&ensp;
          <TooltipText text="Writing">
            <p>Life is too short to die alone without anything to share with others. Because the storage size of text is the lowest (as compared to another form of medium), writing seems to be the most minimalist way to convey thoughts and leave a lot of room for imagination to the reader.</p>
          </TooltipText>
        </li>
